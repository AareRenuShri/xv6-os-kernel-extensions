...
extern uint64 sys_setdisksched(void); //PA4
extern uint64 sys_setraidmode(void); //PA4
extern uint64 sys_setfaileddisk(void); //PA4
...
[SYS_setdisksched]            sys_setdisksched, //PA4
[SYS_setraidmode]             sys_setraidmode,  //PA4
[SYS_setfaileddisk]           sys_setfaileddisk, //PA4
};
